...
// --- METRIC CONVERSIONS ---
// Character is 64px tall, which is ~1.7m (170cm)
const PIXELS_PER_METER = 64 / 1.7; // ~37.65

// --- ROAD DIMENSIONS IN METERS ---
const HIGHWAY_WIDTH_METERS = 7; // ~2 lanes
const NORMAL_ROAD_WIDTH_METERS = 7;
const DEFAULT_SEGMENT_LENGTH_METERS = 150;
...
const defaultConfig = {
    ...
    DEFAULT_SEGMENT_LENGTH: DEFAULT_SEGMENT_LENGTH_METERS * PIXELS_PER_METER,
    HIGHWAY_SEGMENT_LENGTH: HIGHWAY_SEGMENT_LENGTH_METERS * PIXELS_PER_METER,
    MINIMUM_INTERSECTION_DEVIATION: 30,
    ROAD_SNAP_DISTANCE: ROAD_SNAP_DISTANCE_METERS * PIXELS_PER_METER,
